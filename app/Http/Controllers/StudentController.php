        ...
        try {
            $response = Http::timeout(30)
                ...
                ->post("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key={$apiKey}", [
                    'contents' => [['parts' => [['text' => "You are a helpful educational AI assistant. Answer the student's question clearly and simply. Reply in English or Urdu depending on what language the student used.\n\nStudent question: {$question}"]]]],
                    'generationConfig' => [
                        'temperature'     => 0.7,
